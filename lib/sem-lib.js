...
Semaphore.prototype.semTake = function semTake(options, result) {
    let task, timeOut, onTimeOut, onCancel, num, priority, unfair, shouldTakeToken;
    ...
    const item = {
        ...
        setPriority: nextPriority => {
            ...
            nextPriority = toPositiveInt(nextPriority, this.priority);
...
Semaphore.prototype._semTake = function _semTake() {
    ...
    let timerID = this._setImmediateTick(() => {
