...
/* WEBPACK VAR INJECTION */(function(process, global) {var AbstractSortedSet = __webpack_require__(3);
var RedBlackTreeStrategy = __webpack_require__(4);
...
Semaphore.prototype.semTake = function semTake(settings, result) {
    ...
    if (isNumeric(timeOut) && timeOut > 0) {
        var _removeItem = _this._removeItem;
...
AbstractBinaryTreeStrategy = __webpack_require__(5);
...
BinaryTreeIterator = __webpack_require__(6);
